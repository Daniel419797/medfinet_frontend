...
export default tseslint.config(
  { ignores: ["dist"] },
  {
    ...
    files: [
      ...
      "src/admin/pages/{AnalyticsReports,BlockchainEvidence,CaregiverAdministration,ClimateOperations,DeviceAdministration,DonationFlow,EscrowDashboard,GovernanceAdministration,IdentityIntegrityAdministration,IntegrationAdministration,LocalizationAdministration,NotificationAdministration,OperationalOverview,OrganizationLifecycle,OrganizationResources,RewardsOperations,SafetyAdministration,UssdOperations,UserManagement,VaccineScheduleAdministration}.tsx",
      "src/components/auth/**/*.{ts,tsx}",
      "src/components/blockchain/**/*.{ts,tsx}",
      "src/components/common/**/*.{ts,tsx}",
      "src/components/health-worker/Sidebar.tsx",
      "src/components/wallet/WalletStatusButton.tsx",
      "src/contexts/{BlockchainContext,ThemeContext,UserContext}.tsx",
      "src/hooks/useMedfinetApi.ts",
