...
const ApiViewer = () => {
  const [expandedCategory, setExpandedCategory] = useState<string | null>('blockchain');
  ...
  "status": "tokenized"
        ...
        },
        {
          ...
          method: 'GET',
          url: '/api/blockchain/wallet/{walletAddress}/balance',
          parameters: [
            {
              name: 'walletAddress',
              type: 'string',
  ...
  "centers": [
    {
      ...
      "availableVaccines": ["DTaP", "MMR", "Polio", "Hepatitis B"]
        ...
        {
          name: 'Get Child Health Records',
          description: 'Retrieve complete health records for a child',
          method: 'GET',
          url: '/api/health/records/child/{childId}',
          parameters: [
            {
              name: 'childId',
              type: 'string',
  ...
  "entry": [
    {
      "resource": {
        ...
        },
        {
          ...
          description: 'Create a new immunization record',
          method: 'POST',
          url: '/api/fhir/Immunization',
          requestExample: `{
  "resourceType": "Immunization",
  ...
  "disclaimer": "This is not a medical diagnosis. Please consult with a healthcare professional for proper evaluation and treatment."
    ...
    },
    {
      ...
      icon: <QrCode className="h-6 w-6 text-warning-600 dark:text-warning-400" />,
      endpoints: [
        {
  ...
  "data": {
    ...
    "blockchainHash": "0x7f9e8d...6b2c1a"
        ...
        {
          name: 'Store Offline Vaccination',
          description: 'Store vaccination data for offline access',
          method: 'POST',
          url: '/api/qrcode/store-offline',
          requestExample: `{
  "vaccinationData": {
    "id": "vax_123456",
    "childIdHash": "ch_abc123def456",
    ...
    "provider": "Dr. Sarah Johnson"
          ...
          responseExample: `{
  "success": true,
  "storedId": "offline_vax_123456",
  "message": "Vaccination data stored for offline access"
}`
        }
      ]
    },
  ...
  "voices": [
    ...
    },
    {
      ...
      "preview": "https://api.example.com/audio/preview-michael.mp3"
        ...
        {
          name: 'Generate Vaccination Reminder',
          description: 'Generate a voice reminder for vaccination appointments',
          method: 'POST',
          url: '/api/elevenlabs/healthcare/vaccination-reminder',
          requestExample: `{
  "childName": "Jacob Williams",
  "vaccineName": "DTaP",
  "appointmentDate": "2024-08-15",
  "clinicName": "City Pediatrics",
  "language": "en",
  "voiceId": "pNInz6obpgDQGcFmaJgB"
}`,
          responseExample: `{
  "success": true,
  "audioUrl": "https://api.example.com/audio/reminder-12345.mp3",
  "duration": 15.2,
  "message": "Hi! This is a friendly reminder that Jacob Williams has a vaccination appointment for DTaP at City Pediatrics on August 15th. Please make sure to arrive on time and bring your vaccination card."
}`
        }
      ]
    },
    {
      ...
      icon: <Phone className="h-6 w-6 text-neutral-600 dark:text-neutral-400" />,
      endpoints: [
        {
  ...
  "action": "end"
        ...
        {
          name: 'Find Nearby Health Centers',
          description: 'Find nearby health centers via USSD',
          method: 'POST',
          url: '/api/ussd/health-centers/nearby',
          requestExample: `{
  "sessionId": "ATU_123456789",
  "phoneNumber": "+254712345678",
  "location": "Nairobi"
  ...
  "action": "end"
    ...
    },
    {
      ...
      icon: <CreditCard className="h-6 w-6 text-accent-600 dark:text-accent-400" />,
      endpoints: [
        {
  ...
  "expectedRepayment": {
    ...
    "date": "2024-09-25T14:30:00Z"
        ...
        },
        {
          ...
          description: 'Create a payment intent for healthcare services',
          method: 'POST',
          url: '/api/finance/payments/create-intent',
          requestExample: `{
  "amount": 350,
  "currency": "usd",
  ...
  "status": "requires_payment_method"
    ...
    {
      id: 'mapbox',
      name: 'Location Services API',
      description: 'APIs for location-based healthcare services',
      icon: <Map className="h-6 w-6 text-primary-600 dark:text-primary-400" />,
      endpoints: [
        {
          name: 'Geocode Address',
          description: 'Convert an address to coordinates',
          method: 'GET',
          url: '/api/mapbox/geocoding/forward',
          parameters: [
            {
              name: 'address',
              type: 'string',
  ...
  "features": [
    {
      "place_name": "123 Main St, New York, NY 10001, United States",
      ...
      "geometry": {
        ...
        {
          name: 'Find Health Centers',
          description: 'Find nearby health centers using location data',
          method: 'GET',
          url: '/api/mapbox/places/health-centers',
          parameters: [
            {
              name: 'longitude',
              type: 'number',
  ...
  "features": [
    {
      "id": "poi.123456",
      "text": "City Pediatrics",
      "place_name": "City Pediatrics, 123 Main St, New York, NY",
      "center": [-74.0060, 40.7128],
      "properties": {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="space-y-6">
          {filteredCategories.length > 0 ? (
            filteredCategories.map((category) => (
              ...
              >
                <div 
                  className="px-6 py-4 border-b border-neutral-200 dark:border-neutral-700 flex items-center justify-between cursor-pointer hover:bg-neutral-50 dark:hover:bg-neutral-700 transition-colors"
        ...
        <div className="mt-12 bg-white dark:bg-neutral-800 rounded-lg border border-neutral-200 dark:border-neutral-700 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="flex items-start p-4 rounded-lg border border-neutral-200 dark:border-neutral-700 hover:bg-neutral-50 dark:hover:bg-neutral-700 transition-colors group">
        ...
        <div className="mt-8 bg-primary-50 dark:bg-primary-900/20 border border-primary-200 dark:border-primary-800 rounded-lg p-6">
          <div className="flex items-start">
            <Activity className="h-6 w-6 text-primary-600 dark:text-primary-400 mt-0.5 mr-4" />
            <div>
              ...
              <p className="text-sm text-primary-700 dark:text-primary-400 mb-4">
                All API endpoints are relative to the base URL. Replace the base URL with your actual API server address.
              </p>
              <div className="bg-white dark:bg-neutral-800 rounded-lg p-3 border border-primary-200 dark:border-primary-700">
                <div className="flex items-center justify-between">
                  <code className="text-sm font-mono text-neutral-800 dark:text-neutral-200">
                    https://api.medfinet.com/v1
                  </code>
                  <button 
                    onClick={() => handleCopyCode('https://api.medfinet.com/v1')}
                    className="text-primary-600 dark:text-primary-400 hover:text-primary-800 dark:hover:text-primary-300"
                  >
                    <Copy className="h-4 w-4" />
                  </button>
